...
type User struct {
	...
	CanEditUserAttributes NullableBool `json:"canEditUserAttributes,omitempty"`
}
...
// GetCanEditUserAttributes returns the CanEditUserAttributes field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *User) GetCanEditUserAttributes() bool {
	if o == nil || IsNil(o.CanEditUserAttributes.Get()) {
		var ret bool
		return ret
	}
	return *o.CanEditUserAttributes.Get()
}

// GetCanEditUserAttributesOk returns a tuple with the CanEditUserAttributes field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetCanEditUserAttributes gets a reference to the given NullableBool and assigns it to the CanEditUserAttributes field.
func (o *User) SetCanEditUserAttributes(v bool) {
	o.CanEditUserAttributes.Set(&v)
}
// SetCanEditUserAttributesNil sets the value for CanEditUserAttributes to be an explicit nil
func (o *User) SetCanEditUserAttributesNil() {
	o.CanEditUserAttributes.Set(nil)
}
...
func (o User) ToMap() (map[string]interface{}, error) {
	...
	if o.CanEditUserAttributes.IsSet() {
		toSerialize["canEditUserAttributes"] = o.CanEditUserAttributes.Get()
	}
