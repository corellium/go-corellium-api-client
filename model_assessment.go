...
type Assessment struct {
	...
	Wordlist *map[string]interface{} `json:"wordlist,omitempty"`
...
// SetWordlist gets a reference to the given map[string]interface{} and assigns it to the Wordlist field.
