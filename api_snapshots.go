...
type SnapshotsApiV1DeleteSnapshotPermissionsRequest struct {
	ctx context.Context
	ApiService *SnapshotsApiService
	snapshotId string
...
// 
func (r SnapshotsApiV1DeleteSnapshotPermissionsRequest) DeleteSnapshotPermissionsRequestPayload(deleteSnapshotPermissionsRequestPayload DeleteSnapshotPermissionsRequestPayload) SnapshotsApiV1DeleteSnapshotPermissionsRequest {
	r.deleteSnapshotPermissionsRequestPayload = &deleteSnapshotPermissionsRequestPayload
	return r
}

func (r SnapshotsApiV1DeleteSnapshotPermissionsRequest) Execute() (*Snapshot, *http.Response, error) {
	return r.ApiService.V1DeleteSnapshotPermissionsExecute(r)
}

/*
V1DeleteSnapshotPermissions Remove a user from the list of users who have access to the snapshot

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param snapshotId Snapshot ID - uuid
 @return SnapshotsApiV1DeleteSnapshotPermissionsRequest
*/
func (a *SnapshotsApiService) V1DeleteSnapshotPermissions(ctx context.Context, snapshotId string) SnapshotsApiV1DeleteSnapshotPermissionsRequest {
	return SnapshotsApiV1DeleteSnapshotPermissionsRequest{
		ApiService: a,
		ctx: ctx,
		snapshotId: snapshotId,
...
// Execute executes the request
//  @return Snapshot
func (a *SnapshotsApiService) V1DeleteSnapshotPermissionsExecute(r SnapshotsApiV1DeleteSnapshotPermissionsRequest) (*Snapshot, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SnapshotsApiService.V1DeleteSnapshotPermissions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.deleteSnapshotPermissionsRequestPayload == nil {
		return localVarReturnValue, nil, reportError("deleteSnapshotPermissionsRequestPayload is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.deleteSnapshotPermissionsRequestPayload
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type SnapshotsApiV1GetSharedSnapshotsRequest struct {
	ctx context.Context
	ApiService *SnapshotsApiService
}

func (r SnapshotsApiV1GetSharedSnapshotsRequest) Execute() (*Snapshot, *http.Response, error) {
	return r.ApiService.V1GetSharedSnapshotsExecute(r)
}

/*
V1GetSharedSnapshots Fetch snapshots shared with and shared by the requesting user

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SnapshotsApiV1GetSharedSnapshotsRequest
*/
func (a *SnapshotsApiService) V1GetSharedSnapshots(ctx context.Context) SnapshotsApiV1GetSharedSnapshotsRequest {
	return SnapshotsApiV1GetSharedSnapshotsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return Snapshot
func (a *SnapshotsApiService) V1GetSharedSnapshotsExecute(r SnapshotsApiV1GetSharedSnapshotsRequest) (*Snapshot, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SnapshotsApiService.V1GetSharedSnapshots")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type SnapshotsApiV1SetSnapshotPermissionsRequest struct {
	ctx context.Context
	ApiService *SnapshotsApiService
	snapshotId string
...
// 
func (r SnapshotsApiV1SetSnapshotPermissionsRequest) PostSnapshotPermissionsRequestPayload(postSnapshotPermissionsRequestPayload PostSnapshotPermissionsRequestPayload) SnapshotsApiV1SetSnapshotPermissionsRequest {
	r.postSnapshotPermissionsRequestPayload = &postSnapshotPermissionsRequestPayload
	return r
}

func (r SnapshotsApiV1SetSnapshotPermissionsRequest) Execute() (*Snapshot, *http.Response, error) {
	return r.ApiService.V1SetSnapshotPermissionsExecute(r)
}

/*
V1SetSnapshotPermissions Add a user to the list of users who have access to the snapshot

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param snapshotId Snapshot ID - uuid
 @return SnapshotsApiV1SetSnapshotPermissionsRequest
*/
func (a *SnapshotsApiService) V1SetSnapshotPermissions(ctx context.Context, snapshotId string) SnapshotsApiV1SetSnapshotPermissionsRequest {
	return SnapshotsApiV1SetSnapshotPermissionsRequest{
		ApiService: a,
		ctx: ctx,
		snapshotId: snapshotId,
...
// Execute executes the request
//  @return Snapshot
func (a *SnapshotsApiService) V1SetSnapshotPermissionsExecute(r SnapshotsApiV1SetSnapshotPermissionsRequest) (*Snapshot, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SnapshotsApiService.V1SetSnapshotPermissions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.postSnapshotPermissionsRequestPayload == nil {
		return localVarReturnValue, nil, reportError("postSnapshotPermissionsRequestPayload is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.postSnapshotPermissionsRequestPayload
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
