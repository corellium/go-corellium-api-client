...
type DomainOptions struct {
	...
	SnapshotSharingPermissions *SnapshotSharingPermissions `json:"snapshotSharingPermissions,omitempty"`
}
...
// GetSnapshotSharingPermissions returns the SnapshotSharingPermissions field value if set, zero value otherwise.
func (o *DomainOptions) GetSnapshotSharingPermissions() SnapshotSharingPermissions {
	if o == nil || IsNil(o.SnapshotSharingPermissions) {
		var ret SnapshotSharingPermissions
		return ret
	}
	return *o.SnapshotSharingPermissions
}

// GetSnapshotSharingPermissionsOk returns a tuple with the SnapshotSharingPermissions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DomainOptions) GetSnapshotSharingPermissionsOk() (*SnapshotSharingPermissions, bool) {
	if o == nil || IsNil(o.SnapshotSharingPermissions) {
		return nil, false
	}
	return o.SnapshotSharingPermissions, true
}
...
// SetSnapshotSharingPermissions gets a reference to the given SnapshotSharingPermissions and assigns it to the SnapshotSharingPermissions field.
func (o *DomainOptions) SetSnapshotSharingPermissions(v SnapshotSharingPermissions) {
	o.SnapshotSharingPermissions = &v
}
...
func (o DomainOptions) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SnapshotSharingPermissions) {
		toSerialize["snapshotSharingPermissions"] = o.SnapshotSharingPermissions
	}
