...
type Instance struct {
	...
	Netmon NullableInstanceNetmonState `json:"netmon,omitempty"`
	// 
...
// SetNetmon gets a reference to the given NullableInstanceNetmonState and assigns it to the Netmon field.
func (o *Instance) SetNetmon(v InstanceNetmonState) {
	o.Netmon.Set(&v)
}
// SetNetmonNil sets the value for Netmon to be an explicit nil
func (o *Instance) SetNetmonNil() {
	o.Netmon.Set(nil)
}
