...
type InstancesApiV1GetInstanceRateRequest struct {
	ctx context.Context
	ApiService *InstancesApiService
	instanceId string
}

func (r InstancesApiV1GetInstanceRateRequest) Execute() (*RateInfo, *http.Response, error) {
	return r.ApiService.V1GetInstanceRateExecute(r)
}

/*
V1GetInstanceRate Get rate information
...
Returns the cost, in microcents, for the instance in the on and off state. Instances are charged $0.25 / day for storage (off) and $0.25 per core per hour (on).
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param instanceId Instance ID - uuid
 @return InstancesApiV1GetInstanceRateRequest
*/
func (a *InstancesApiService) V1GetInstanceRate(ctx context.Context, instanceId string) InstancesApiV1GetInstanceRateRequest {
	return InstancesApiV1GetInstanceRateRequest{
		ApiService: a,
		ctx: ctx,
		instanceId: instanceId,
...
// Execute executes the request
//  @return RateInfo
func (a *InstancesApiService) V1GetInstanceRateExecute(r InstancesApiV1GetInstanceRateRequest) (*RateInfo, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InstancesApiService.V1GetInstanceRate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/instances/{instanceId}/rate"
	localVarPath = strings.Replace(localVarPath, "{"+"instanceId"+"}", url.PathEscape(parameterValueToString(r.instanceId, "instanceId")), -1)
...
/*
V1InstancesInstanceIdMessagePost Receive a message on an iOS vm
...
func (r InstancesApiV1PostInstanceInputRequest) Execute() (int32, *http.Response, error) {
...
// Execute executes the request
//  @return int32
func (a *InstancesApiService) V1PostInstanceInputExecute(r InstancesApiV1PostInstanceInputRequest) (int32, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
